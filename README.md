...
## Algorithm
1. Collect and preprocess employee data by handling missing values and encoding categorical features.

2. Split the dataset into training and testing sets.

3. Train the Decision Tree Classifier using the training data.

4. Evaluate the model accuracy and use it to predict employee churn.
...
<img width="843" height="817" alt="image" src="https://github.com/user-attachments/assets/9267bad6-57fe-4a2e-8d40-891adfed3fe5" />

<img width="1123" height="807" alt="image" src="https://github.com/user-attachments/assets/89412306-427b-44e8-9ff8-37dc6c3f7513" />
